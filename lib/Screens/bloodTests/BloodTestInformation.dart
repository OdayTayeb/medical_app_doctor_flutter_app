...
class BloodTestInformation extends StatelessWidget {
  const BloodTestInformation({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {

    final arguments = (ModalRoute.of(context)?.settings.arguments ?? <String, dynamic>{}) as Map;
    BloodTestInfo info = arguments['info'];
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  await Navigator.pushNamed(context, '/addbloodtest',arguments: {
                    'info': info,
                  });
