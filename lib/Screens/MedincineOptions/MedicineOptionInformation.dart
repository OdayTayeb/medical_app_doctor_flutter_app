...
class MedicineOptionInformation extends StatelessWidget {
  const MedicineOptionInformation({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {

    final arguments = (ModalRoute.of(context)?.settings.arguments ?? <String, dynamic>{}) as Map;
    MedicineOptionsInfo info = arguments['info'];
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                  onPressed: () async {
                    await Navigator.pushNamed(context, '/addmedicineoption',arguments: {
                      'info': info,
                    });
