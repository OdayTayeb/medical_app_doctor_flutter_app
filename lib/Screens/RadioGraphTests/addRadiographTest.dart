...
class addRadioGraphTest extends StatefulWidget {
  const addRadioGraphTest({Key? key}) : super(key: key);

  @override
  State<addRadioGraphTest> createState() => _addRadioGraphTestState();
}

class _addRadioGraphTestState extends State<addRadioGraphTest> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text(AppLocalizations.of(context)!.radioGraphInformation,style: TextStyle(color: Colors.black),),
        ),
      body: Column(
              children: [
                Name(),
                Comment(),
                addNewRadioGraphTestButton(),
              ],
            ),
    );
  }
        ...
        SizedBox(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: AppLocalizations.of(context)!.enterRadioGraphTestName,
                hintStyle: TextStyle(
  ...
  Widget addNewRadioGraphTestButton(){
    return Expanded(
        child: Align(
                ...
                if (!valuesIsInit) {
                  response = await http.post(
                    ...
                    body: jsonEncode(<String, String>{
                      "radiographName": nameController.text,
                  ...
                  response = await http.put(
                    Uri.parse(URL + '/api/radiograph/' + info.id),
                    headers: <String, String>{
                      'Content-Type': 'application/json',
                      'Accept': '*/*',
                      'Connection': 'keep-alive',
